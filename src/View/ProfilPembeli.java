 ...
 */
public class ProfilPembeli extends javax.swing.JFrame {
     ...
     */
    public ProfilPembeli(Pembeli loginUser) {
        initComponents();  
        getData();
    }
    ...
    private void getData(){
        ...
        Pembeli pem = cp.getId(loginUser.getUsername());
        fieldUsername.setText(pem.getUsername());
        fieldNama.setText(pem.getNama());
        fieldEmail.setText(pem.getEmail());
        fieldAlamat.setText(pem.getAlamat());
        fieldPass.setText(pem.getPassword());
    }
    ...
    private void updateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateMouseClicked
        ...
        if(!fieldUsername.getText().equals("") && !fieldNama.getText().equals("") && !fieldEmail.getText().equals("") && !fieldAlamat.getText().equals("")&& !fieldPass.getText().equals("")){
            ...
            cp = new PembeliController();
            int hasil = cp.updatePembeli(pembeli);
            if (hasil == -1){
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseClicked
        // TODO add your handling code here:
        DashboardPembeli dashboard = new DashboardPembeli(loginUser);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProfilPembeli.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
