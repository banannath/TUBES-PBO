...
import static View.DashboardPembeli.loginUser;
...
public class Checkout extends javax.swing.JFrame {
     ...
     */
    public Checkout(Pembeli loginUser) {
        initComponents();
        showTable();
    }
    ...
    private void showTable(){
        List <Keranjang> list = ck.getAllKeranjang(); 
        Object[][] objectkrg = new Object[list.size()][6]; 
        int i =0 ; 
        for (Keranjang krg : list) { 
            objectkrg[i][0] = krg.getId_barang();
            objectkrg[i][1] = krg.getNamabarang();
            objectkrg[i][2] = krg.getKategoribarang();
            objectkrg[i][3] = krg.getHargabarang();
            objectkrg[i][4] = krg.getQty();
            objectkrg[i][5] = krg.getTotalharga();
            i++; //increment
        }
        tabel.setModel(new javax.swing.table.DefaultTableModel(objectkrg, new  String[] {"ID  Barang", "Nama Barang", "Kategori Barang", "Harga Barang", "Qty", "Total Harga"}));
    ...
    private void initComponents() {
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(814, 525));
    ...
    private void jPanel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel3MouseClicked
        ...
        for (Keranjang krg : list) { 
            ...
            String id_barang = objectkrg[i][0].toString();
            String username = loginUser.getUsername();
            String nama = objectkrg[i][1].toString();
            String kategori = objectkrg[i][2].toString();
            int harga = Integer.parseInt(objectkrg[i][3].toString());
            int jumlah = Integer.parseInt(objectkrg[i][4].toString());
            int totalharga = Integer.parseInt(objectkrg[i][5].toString());
        ...
        if (list.isEmpty()){
            JOptionPane.showMessageDialog(null,"Tidak ada barang dalam keranjang"); 
        }else {
    ...
    private void jPanel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel4MouseClicked
        ...
        int hasil = ck.deleteDataKeranjang(id_barang);
        if (hasil == -1) {
